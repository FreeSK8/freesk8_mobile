...
class SerializeFirmware62 { //fw6

  static const int MCCONF_SIGNATURE_FW6_2 = 776184161; //fw6
  static const int APPCONF_SIGNATURE_FW6_2 = 486554156;
  ...
  APPCONF processAPPCONF(Uint8List buffer) {
    ...
    if (signature != APPCONF_SIGNATURE_FW6_2) { //fw6
      globalLogger.e("Invalid APPCONF signature; received $signature expecting $APPCONF_SIGNATURE_FW6_2");
      return appconfData;
    }
    ...
    //globalLogger.wtf("SerializeFirmware62::processAPPCONF: final index = $index");
    return appconfData;
  }
  ...
  ByteData serializeAPPCONF(APPCONF conf) {
    ...
    response.setUint32(index, APPCONF_SIGNATURE_FW6_2); index += 4;
    ...
    //globalLogger.wtf("SerializeFirmware62::serializeAPPCONF: final index is $index");
    return response;
  }
  ...
  MCCONF processMCCONF(Uint8List buffer) {
    ...
    int signature  = buffer_get_uint32(buffer, index); index += 4;
    if (signature != MCCONF_SIGNATURE_FW6_2) {
      globalLogger.e("Invalid MCCONF Signature. Received $signature but expected $MCCONF_SIGNATURE_FW6_2");
      //Return empty mcconf
      return mcconfData;
    }
    ...
    mcconfData.foc_sat_comp = buffer_get_float16(buffer, index, 100); index += 2; //check if scaling value is correct
    ...
    //globalLogger.wtf("SerializeFirmware62::processMCCONF: final index = $index");
    return mcconfData;
  }
  ...
  ByteData serializeMCCONF(MCCONF conf) {
    ...
    response.setUint32(index, MCCONF_SIGNATURE_FW6_2); index += 4;
    ...
    //globalLogger.wtf("SerializeFirmware62::serializeMCCONF: final index is $index");
    return response;
  }
}
