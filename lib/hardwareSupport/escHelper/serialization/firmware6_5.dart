...
class SerializeFirmware65 { //fw6.5

  static const int MCCONF_SIGNATURE_FW6_5 = 295158857;      //fw6.5
  static const int APPCONF_SIGNATURE_FW6_5 = 2099347128;    //fw6.5
  ...
  APPCONF processAPPCONF(Uint8List buffer) {
    ...
    if (signature != APPCONF_SIGNATURE_FW6_5) { //fw6.3
      globalLogger.e("Invalid APPCONF signature; received $signature expecting $APPCONF_SIGNATURE_FW6_5");
      return appconfData;
    }
  ...
  ByteData serializeAPPCONF(APPCONF conf) {
    int index = 0;
    ByteData response = new ByteData(278); //TODO: ByteData is not dynamic, setting exact size
    response.setUint32(index, APPCONF_SIGNATURE_FW6_5); index += 4;
  ...
  MCCONF processMCCONF(Uint8List buffer) {
    ...
    int signature  = buffer_get_uint32(buffer, index); index += 4;
    if (signature != MCCONF_SIGNATURE_FW6_5) {
      globalLogger.e("Invalid MCCONF Signature. Received $signature but expected $MCCONF_SIGNATURE_FW6_5");
      //Return empty mcconf
      return mcconfData;
    }
    ...
    mcconfData.l_in_current_map_start = buffer_get_float16(buffer, index, 10000); index += 2;   //fw6.2
    mcconfData.l_in_current_map_filter = buffer_get_float16(buffer, index, 10000); index += 2;  //fw6.2 
    ...
    mcconfData.l_min_vin = buffer_get_float16(buffer, index, 10); index += 2;   //fw6.2
    mcconfData.l_max_vin = buffer_get_float16(buffer, index, 10); index += 2;   //fw6.2
    mcconfData.l_battery_cut_start = buffer_get_float16(buffer, index, 10); index += 2; //fw6.2
    mcconfData.l_battery_cut_end = buffer_get_float16(buffer, index, 10); index += 2;   //fw6.2
    mcconfData.l_battery_regen_cut_start = buffer_get_float16(buffer, index, 10); index += 2;   //fw6.2
    mcconfData.l_battery_regen_cut_end = buffer_get_float16(buffer, index, 10); index += 2;     //fw6.2
    ...
    mcconfData.foc_sl_erpm_start = buffer_get_float32_auto(buffer, index); index += 4;        //fw6.2
    mcconfData.foc_sl_erpm = buffer_get_float32_auto(buffer, index); index += 4;
    mcconfData.foc_control_sample_mode = mc_foc_control_sample_mode.values[buffer[index++]];  //fw6.2
    mcconfData.foc_current_sample_mode = mc_foc_current_sample_mode.values[buffer[index++]];  //fw6.2
    mcconfData.foc_sat_comp_mode = SAT_COMP_MODE.values[buffer[index++]]; //fw6
    mcconfData.foc_sat_comp = buffer_get_float16(buffer, index, 1000); index += 2;
    ...
    mcconfData.s_pid_speed_source = S_PID_SPEED_SRC.values[buffer[index++]];    //fw6.2
  ...
  ByteData serializeMCCONF(MCCONF conf) {
    int index = 0;
    ByteData response = new ByteData(484); //TODO: ByteData is not dynamic, setting exact size
    response.setUint32(index, MCCONF_SIGNATURE_FW6_5); index += 4;
    ...
    response.setInt16(index, (conf.l_in_current_map_start * 10000).toInt()); index += 2;  //fw6.2
    response.setInt16(index, (conf.l_in_current_map_filter * 10000).toInt()); index += 2;  //fw6.2
    ...
    response.setInt16(index, (conf.l_min_vin * 10).toInt()); index += 2;  //fw6.2
    response.setInt16(index, (conf.l_max_vin * 10).toInt()); index += 2;  //fw6.2
    response.setInt16(index, (conf.l_battery_cut_start * 10).toInt()); index += 2;  //fw6.2
    response.setInt16(index, (conf.l_battery_cut_end * 10).toInt()); index += 2;  //fw6.2
    response.setInt16(index, (conf.l_battery_regen_cut_start * 10).toInt()); index += 2;  //fw6.2
    response.setInt16(index, (conf.l_battery_regen_cut_end * 10).toInt()); index += 2;  //fw6.2
    ...
    response.setFloat32(index, conf.foc_sl_erpm_start); index += 4;    //fw6.2
    response.setFloat32(index, conf.foc_sl_erpm); index += 4;
    response.setUint8(index++, conf.foc_control_sample_mode.index);   //fw6.2
    response.setUint8(index++, conf.foc_current_sample_mode.index);   //fw6.2
    ...
    response.setInt16(index, (conf.foc_sat_comp * 1000).toInt()); index += 2;
    ...
    response.setUint8(index++, conf.s_pid_speed_source.index);
